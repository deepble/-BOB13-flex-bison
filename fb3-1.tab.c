...
#line 22 "fb3-1.y"
                       {
        printf("= %4.4g\n", eval((yyvsp[-1].a))); /* evaluate and print the AST */
        treefree((yyvsp[-1].a)); /* free up the AST */
        printf("> ");
    }
#line 1085 "fb3-1.tab.c"
    break;

  case 4: /* calclist: calclist EOL  */
#line 27 "fb3-1.y"
                   { printf("> "); }
#line 1091 "fb3-1.tab.c"
    break;

  case 6: /* exp: exp '+' factor  */
#line 32 "fb3-1.y"
                     { (yyval.a) = newast('+', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1097 "fb3-1.tab.c"
    break;

  case 7: /* exp: exp '-' factor  */
#line 33 "fb3-1.y"
                     { (yyval.a) = newast('-', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1103 "fb3-1.tab.c"
    break;
...
#line 45 "fb3-1.y"
                  { (yyval.a) = (yyvsp[-1].a); }
#line 1133 "fb3-1.tab.c"
    break;

  case 14: /* term: '-' term  */
#line 46 "fb3-1.y"
               { (yyval.a) = newast('M', (yyvsp[0].a), NULL); }
#line 1139 "fb3-1.tab.c"
    break;


#line 1143 "fb3-1.tab.c"
